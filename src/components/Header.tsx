...
export const Header: React.FC<HeaderProps> = ({
  ...
  const navItems = [
    ...
    },
    {
      ...
      description: "Quản lý 20 nhóm, phân loại ca sáng/tối",
      icon: Cpu,
    ...
    },
    {
      ...
      shortTitle: "Giám Sát",
      description: "Theo dõi tiến độ gửi bài thời gian thực",
      icon: Terminal,
  ...
  return (
    <header className="border-b border-slate-200 bg-white sticky top-0 z-30 px-2.5 sm:px-6 py-2 shadow-xs transition-colors">
      <div className="max-w-7xl mx-auto space-y-1.5 md:space-y-0 md:flex md:items-center md:justify-between md:gap-4">
        {/* Row 1 on Mobile: Logo, Status Badges & Quick Tools */}
        <div className="flex items-center justify-between gap-2">
          ...
          {/* Quick Action Buttons (Available on ALL screen sizes) */}
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            <button
              ...
              className="px-2 py-1 rounded-lg bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 text-emerald-900 text-[10px] sm:text-xs font-semibold flex items-center gap-1 transition-colors whitespace-nowrap shadow-2xs"
              title="Cài đặt chạy ẩn liên tục trên điện thoại"
            >
              <Smartphone className="w-3 h-3 text-emerald-600" />
              <span className="hidden xs:inline">Chạy Ẩn</span>
            </button>
            ...
            <button
              ...
              title="Tải mã nguồn Playwright Node.js"
            >
